...
<head>
	...
	<body>
		<form action="Valida.php" method="POST" > <!--criando o formulario, colocando o metodo utilizado e a ação com uma variavel que será atribuida no outro arquivo -->
			<div align="center"> 
			<center><h3><b>Exercicio 6</b><h3></center><td>
				<table border="0" cellspacing="1" cellpading="0"><!--criando tabela -->
					...
					<tr>
						...
						<td>
						Masc. <input type="radio" name="sexos" value="Masculino"  >
						| Fem.<input type="radio" name="sexos" value="Feminino" >
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="cidades" size="20"  autofocus></td> <!--tipo do campo, nome e tamanho-->
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="checkbox" name="termo" ></td>
					</tr>
					<tr>
					...
					<!-- <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/BD777F00-7324-844A-8FC5-DFF731BDB22B/main.js" charset="UTF-8"></script></head>-->
				</table>
			</div>
		</form>
	</body>
